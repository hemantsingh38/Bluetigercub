  ...
  return (
    <>
      <section className="relative mx-auto max-w-[1560px] px-6 pb-16 pt-20 sm:px-9 sm:pt-28">
        <Reveal>
          <p className="max-w-4xl text-4xl leading-[1.35] text-text-primary">
        ...
        <Reveal
          delay={0.15}
          className="relative ml-[calc(50%-50vw)] mt-8 aspect-[1513/800] w-screen max-h-[36vh] overflow-hidden sm:mt-4 sm:max-h-[52vh]"
        >
          <Image
